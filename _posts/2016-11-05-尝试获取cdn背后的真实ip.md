---
layout:     post
title:      尝试获取cdn背后的真实ip
date:       2016-11-05
summary:    尝试获取cdn背后的真实ip
categories: web
tags:
 - cdn
 - python
...
1.use masscan but not nmap,code will install it if doesn't exist  
2.linux,ubuntu best,flushdns func test on ubuntu only  
3.usage:  

    eg.python3 xcdn.py www.baidu.com

4.need vpn on[some domain will be blocked by GFW,and this will make the result wrong]

### 0x02 pycode

download:<a href="https://raw.githubusercontent.com/3xp10it/mytools/master/xcdn.py">xcdn.py</a>
