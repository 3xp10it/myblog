...
if (ObjC.available)
{
    try
    {
        ...
        Interceptor.attach(hook.implementation, {
          ...
          onLeave: function(retval) {
            console.log("Original retval-> type:"+typeof retval+" value:"+retval)

            newretval=ptr("xxxx")
            retval.replace(newretval)
            console.log("New retval-> type:"+typeof newretval+" value:"+newretval)
          }
        });
    }
    catch(err)
