...
如下代码中调用了PARSHealthPedometer10thHomeViewController类中的requestUploadWithSure函数,其中函数的参数为1,如果requestUploadWithSure函数没有参数,则写法为`my_obj["- requestUploadWithSure"]()`,如果要调用一个类的函数,有2种情况:
