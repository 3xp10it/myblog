...
333.查看乌云完整文章方法
    https://web-beta.archive.org/web/20160719120927/http://drops.wooyun.org:80/
...
340.logmein支持不同内网间直接ssh登录,用logmein hamachi加入或创建网络即可
...
258.最简单的百度云限速破解                
    用chrome设置用手机打开对应下载页面后下载,然后打开chrome的下载页面,复制下载链接用迅雷下载即可,如果不行则将要
    下载的文件放到一个文件夹,同样用chrome的手机模式下载文件夹后获取下载地址再用迅雷下载
