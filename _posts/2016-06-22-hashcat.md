...
title:      hashcat&john
date:       2016-06-22
summary:    crack passwords with hashcat and john
categories: crack
tags:
 - hashcat
---
...
破解wpa/wpa2:
    ...
    2)https://github.com/hashcat/hashcat-utils/releases    这个里面的cap2hccapx.bin(macOS下运行不成功)或
    cap2hccapx.exe(win32下不能运行,可能是64位的exe)
